...
function buildGraph(): { nodes: Node[]; edges: Edge[] } {
  const nodes: Node[] = [
    ...
    { id: 'kafka-source',type: 'pipeline', position: { x: COL.src,    y: ROW.bot }, data: { label: 'Kafka',              sublabel: 'shopstream.finance',              logoKey: 'kafka',     url: 'https://confluent.cloud/environments/env-0y0o0q/clusters/lkc-96xymm/overview', status: 'active', tag: 'confluent cloud',    category: 'source',      animDelay: 1 } },
